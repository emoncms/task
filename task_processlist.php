...
class Task_ProcessList {
    ...
    public function process_list() {
        ...
        $list[] = array(_("Feed last update > secs, go to next"), ProcessArg::VALUE, "feed_last_update_higher", 0, DataType::UNDEFINED, "Time", 'desc' => _("<p>Using the value of previous process as a feed id, the execution of the processlist will carry on if the feed hasn't been updated for the specified amount of seconds. Otherwise it will stop. </p>"), 'requireredis' => false, 'nochange' => true);
        $list[] = array(_("Input last update > secs, go to next"), ProcessArg::VALUE, "input_last_update_higher", 0, DataType::UNDEFINED, "Time", 'desc' => _("<p>Using the value of previous process as an input id, the execution of the processlist will carry on if the input hasn't been updated for the specified amount of seconds. Otherwise it will stop. </p>"), 'requireredis' => false, 'nochange' => true);
